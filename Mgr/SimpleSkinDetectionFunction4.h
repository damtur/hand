...
namespace HandGR{
	...
	class SimpleSkinDetectionFunction4: public SkinDetectionFunction{
	public:
		SimpleSkinDetectionFunction4(bool initialFilterEnabled = true) : SkinDetectionFunction(initialFilterEnabled){}
